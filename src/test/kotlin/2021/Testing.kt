...
class Testing {
    ...
    fun day17Tests() {
        ...
        assertEquals(DaySeventeen.shoot(Pair(7L, 2L), ranges), 3L)
        assertEquals(DaySeventeen.shoot(Pair(6L, 3L), ranges), 6L)
        assertEquals(DaySeventeen.shoot(Pair(9L, 0L), ranges), 0L)
        assertEquals(DaySeventeen.shoot(Pair(17L, -4L), ranges), Long.MIN_VALUE)
    }
    ...
    @Test
    fun day19Tests() {
        assertEquals(Point3D(1,2,3).getPermutations().size, 20)
    }
    ...
    @Test
    fun day22Sample() {
        testSample(22, 474140, 2758514936282235L)
    }

    @Test
    fun day22() {
        test(22, 589411, 1130514303649907L)
    }

    @Test
    fun day23Sample() {
        testSample(23, 12521, 44169)
    }
    ...
    @Test
    fun day24Sample() {
        testSample(24, 92928914999991L, 91811211611981L)
    }

    @Test
    fun day24() {
        test(24, 92928914999991L, 91811211611981L)
    }
